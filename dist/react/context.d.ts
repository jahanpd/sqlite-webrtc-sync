 ...
 * ```
 */
export declare function DatabaseProvider<S extends SchemaDef>({ name, schema, mode, peerServer, discoveryInterval, onFallbackToCloud, onPeerError, children, }: DatabaseProviderProps<S>): React.ReactElement | null;
/**
